	...
	public static partial class OrderExts
	{
		public static OrderEntity ToEntity(this Order source)
		{
			...
			return new OrderEntity(source.Id,
				...
				{ RequestRefund = source.RequestRefund, RequestRefundTime = source.RequestRefundTime };
		}

		public static ShippingInfo GetShippingInfo(this Order source)
		{
			return new ShippingInfo
				{ Receiver = source.Receiver, Address = source.Address, CellPhone = source.CellPhone };
		}
	}
}